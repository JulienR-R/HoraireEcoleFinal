    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.admin_employeview:
                 intent = new Intent(AdminCenterActivity.this, EmployeViewActivity.class);
                startActivity(intent);
                break;
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
            ...
            switch (menuItem.getItemId()) {
                ...
                case R.id.nav_creation_horaire:
                        ...
                        intent = new Intent(AdminCenterActivity.this, HoraireCreationActivity.class);
                        startActivity(intent);
                ...
                case R.id.nav_creation_usager:
                    ...
                    intent = new Intent(AdminCenterActivity.this, EmployeCreationActivity.class);
                    startActivity(intent);
