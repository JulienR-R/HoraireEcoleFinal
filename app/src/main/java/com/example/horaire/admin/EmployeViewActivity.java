...
public class EmployeViewActivity extends AppCompatActivity implements Fragment_Edit_Delete_Emp.OnFragmentInteractionListener {

    private RecyclerView recyclerView;
    private List<User> usersList;
    private  Emp_Adapter adapter = new Emp_Adapter();
    ...
    //    ListView list;
        ...
        setContentView(R.layout.emp_view);
      ...
      /*
        ...
        */
        ...
        adapter.setOnItemClickListener(new Emp_Adapter.OnItemClickListener() {
            @Override
    ...
    private void openFragment(User user) {
        Fragment_Edit_Delete_Emp fragment_editDelete_emp =  Fragment_Edit_Delete_Emp.newInstance(user);
