...
public class PopulateDatabase {
    ...
    public void addUsers(){
        List<User> userList = Arrays.asList(new User[]{
                new User("marco@gmail.com", "password", 0,  "marco", "verrati"),
                new User("venom@gmail.com", "password1", 1, "brock", "lesnar" ),
                new User("party@gmail.com", "password2", 2, "party", "allnight"),
                new User("loope@gmail.com", "password3", 3, "loope", "infinity"),
                new User("gino@gmail.com", "password4", 4, "gino", "cochino"),
                new User("math@gmail.com", "password5", 5, "math", "trigo"),
                new User("louiz@gmail.com", "password6", 6, "louiz", "cyr"),
                new User("phillipe@gmail.com", "password7", 7, "phillipe", "desureault"),
                new User("karl@gmail.com", "password8", 8, "karl", "lagerfeld"),
                new User("papounet@gmail.com", "password9", 9, "papounet", "pouchom")
        });
