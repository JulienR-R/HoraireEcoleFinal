...
public interface ChoixPlageHoraireAccess {
    ...
    @Query("SELECT * FROM choixPlageHoraire Where actif = 1")
    List<ChoixPlageHoraire> getActivesChoixPlageHoraires();

    @Query("SELECT * FROM choixPlageHoraire Where userId = :userId")
    List<ChoixPlageHoraire> getChoixPlageHorairesByUser(long userId);

    @Query("SELECT * FROM choixPlageHoraire Where plageHoraireId = :plageHoraireId")
    List<ChoixPlageHoraire> getChoixPlageHorairesByPlageHoraire(long plageHoraireId);
