...
public interface AttributionPlageHoraireAccess {
    ...
    @Query("SELECT * FROM attributionPlageHoraire WHERE idChoixPlageHoraire = :idChoixPlageHoraire")
    AttributionPlageHoraire getAttributionPlageHoraireByChoix(int idChoixPlageHoraire);
